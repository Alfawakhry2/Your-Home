...
<body>
    ...
    <div class="content">
        ...
        <p>Thank you for verifying your email address and joining our community. We're thrilled to have you on board!</p>

        <p>Here's what you can do next:</p>

        <a href="{{ url('/') }}" class="button">Go to Your Dashboard</a>
