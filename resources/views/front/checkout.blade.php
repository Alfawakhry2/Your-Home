                    ...
                    <div class="row g-0">
                        <div class="col-md-5 position-relative">
                            <img src="{{ asset('storage/' . $estate->image) }}"
                                 ...
                                 alt="صورة العقار">
                            <span class="badge bg-{{ $estate->type === 'rent' ? 'info' : 'success' }} position-absolute top-0 end-0 m-2">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="payment-methods">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <input type="radio" name="payment_method" id="credit-card" class="d-none" checked>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-lg py-3 fw-bold">
                                    <i class="bi bi-lock-fill me-2"></i> Confirm Pay & Reservation
                                </button>
                            </div>
